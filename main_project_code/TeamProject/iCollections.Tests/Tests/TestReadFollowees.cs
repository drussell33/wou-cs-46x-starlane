...
namespace iCollections.Tests.Tests
{
    public class TestReadFollowees
    {
        ...
        [Test]
        public void ReadFollowees_GivenManyFolloweesAdds_TheirFolloweesAndCollections()
        {
            var brock = new IcollectionUser { Id = 1, FirstName = "Brock" };
            var lily = new IcollectionUser { Id = 2, FirstName = "Lily" };
            var john = new IcollectionUser { Id = 3, FirstName = "John" };
            ...
            List<Follow> follows = new List<Follow>{
                ...
                new Follow {Id = 5, Follower = 4,Followed = 3,Began = new DateTime(2009, 4, 23, 12, 0, 0),FollowedNavigation = john,FollowerNavigation = damon},
                new Follow {Id = 6, Follower = 5,Followed = 3,Began = new DateTime(2002, 7, 2, 4, 0, 0),FollowedNavigation = john,FollowerNavigation = will},
                new Follow {Id = 7, Follower = 4,Followed = 2,Began = new DateTime(2012, 4, 23, 12, 0, 0),FollowedNavigation = lily,FollowerNavigation = damon},
                new Follow {Id = 8, Follower = 3,Followed = 5,Began = new DateTime(2021, 7, 2, 4, 0, 0),FollowedNavigation = will,FollowerNavigation = john},
                new Follow {Id = 9, Follower = 1,Followed = 6,Began = new DateTime(2003, 4, 23, 12, 0, 0),FollowedNavigation = franklin,FollowerNavigation = brock},
                new Follow {Id = 10, Follower = 1,Followed = 5,Began = new DateTime(2015, 7, 2, 4, 0, 0),FollowedNavigation = will,FollowerNavigation = brock}
            };
            ...
            List<Collection> cols = new List<Collection>{
                ...
                new Collection {Id = 16, Name = "Mexico Vacation Photos", UserId = 6, DateMade = new DateTime(2016, 10, 10, 15, 28, 0), User = franklin, Visibility = 1},
                new Collection {Id = 17, Name = "Fishing Poles", UserId = 6, DateMade = new DateTime(2012, 11, 21, 18, 52, 0), User = franklin, Visibility = 1},
                new Collection {Id = 18, Name = "Boats", UserId = 6, DateMade = new DateTime(2010, 6, 2, 7, 31, 0), User = franklin, Visibility = 1}
            };

            List<IcollectionUser> whoIFollow = new List<IcollectionUser>();
            whoIFollow.Add(franklin);
            whoIFollow.Add(will);
            ...
            DatabaseHelper.ReadFollowees(whoIFollow, topFollow, followeesCollections, 1, followRepo, collectionRepo);
            Assert.That(topFollow.Count, Is.EqualTo(1));
            Assert.That(followeesCollections.Count, Is.EqualTo(6));
        }
    }
}