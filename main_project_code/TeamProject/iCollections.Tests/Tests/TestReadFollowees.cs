    ...
    public class TestReadFollowees
    {
        ...
        public void ReadFollowees_GivenManyFolloweesAdds_TheirFolloweesAndCollections()
        {
            ...
            List<Collection> cols = new List<Collection>{
                ...
                new Collection {Id = 14, Name = "My Posters", UserId = 5, DateMade = new DateTime(2014, 11, 21, 18, 52, 0), User = will},
                new Collection {Id = 15, Name = "My Funco Pops", UserId = 5, DateMade = new DateTime(2012, 6, 2, 7, 31, 0), User = will},
                new Collection {Id = 16, Name = "Mexico Vacation Photos", UserId = 6, DateMade = new DateTime(2016, 10, 10, 15, 28, 0), User = franklin},
                new Collection {Id = 17, Name = "Fishing Poles", UserId = 6, DateMade = new DateTime(2012, 11, 21, 18, 52, 0), User = franklin},
                new Collection {Id = 18, Name = "Boats", UserId = 6, DateMade = new DateTime(2010, 6, 2, 7, 31, 0), User = franklin}
            };
